  ...
  return (
    <div className="fixed bottom-3 right-3 z-[60] w-[min(20rem,calc(100vw-1.5rem))]">
      ...
      <div className="glass-panel overflow-hidden rounded-3xl">
        ...
        >
          <span className="grid h-10 w-10 shrink-0 place-items-center rounded-xl border border-gold/40 bg-accent/40">
        ...
        <div className="px-3 pb-3">
          ...
          <div className="mt-2 flex items-center justify-center gap-2">
            ...
            <button
              ...
              className="grid h-12 w-12 place-items-center rounded-full border border-gold/60 bg-[image:var(--gradient-violet)] text-primary-foreground shadow-[var(--shadow-glow)]"
            >
